 ...
 * 
 * @author momocasew
 * @emotionless NelttjeN
 */
public class GodDrinksJava {
    public static void main(String[] args) {

        Thing me = new Lovable("NelttjeN", 0, true, -1, false);

        Thing you = new Lovable("Nobody", 0, false, -1, false);  //TODO: Place here name of lovely girl
        ...
        world.timeTravelForTwo("DB", 3691, me, you);
        ...
        try {
            me.setOption(me.getOptionIndex("you are here"), false);
        }
